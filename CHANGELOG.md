...
## [1.9.1] - 2026-07-06
- Updated README to refer local MCP server
...
### Changed
- Deleted apiKey field from `TranslationConfig` for safety propose
- Updated README
...
### Changed
- Extended information about how much glossary, content itself, terminology, and linguistic instruction contribute in debiting of character balance during translation. Added details to logs.
- Improved CLI option description.
- Updated to use `ai-l10n-sdk@1.7.1` and `ai-l10n-core@1.7.1`
...
### Changed
- Updated to use `ai-l10n-sdk@1.6.2` and `ai-l10n-core@1.6.2`
